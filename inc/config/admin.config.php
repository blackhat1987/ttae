...
$menu['apps'] = array(
		...
		'nav'=>array(
				...
				array('name'=>'消息推送',		'a'=>'push'	),
						...
						array('name'=>'小程序首页幻灯片',		'a'=>'xiaohdp'),
						array('name'=>'小程序六宫格',		'a'=>'xiaogezi'),
		)
);
$menu['nav'] = array(
		'type'=>1,
...
$menu['goods'] = array(
		...
		'nav'=>array(
			...
			array('name'=>'大淘客优惠券采集',		'a'=>'quan_setting'),
			array('name'=>'好品推优惠券采集',		'a'=>'hpt_setting'),
...
$menu['weixin'] = array(
		...
		'name'=>'微信管理',
		'nav'=>array(
			array('name'=>'专题推送',		'a'=>'main'	,'type'=>	1),
			array('name'=>'专题添加',		'a'=>'list_post'	,'type'=>	1),
			array('name'=>'文章管理',		'a'=>'news_main'	,'type'=>	1),
			array('name'=>'文章添加',		'a'=>'post'	,'type'=>	1),
			
			
			array('name'=>'微信设置',		'a'=>'setting'	,'type'=>	1),
		)
);
$menu['img'] = array(
	'type'=>2,
