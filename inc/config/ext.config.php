...
$ext['jf_type'] 		= array('system'=>'系统奖励','sign'=>'签到积分','yaoqing'=>'邀请任务','web'=>'站点分享','goods'=>'商品分享','favorite'=>'添加收藏','duihuan'=>'积分兑换');
...
$ext['order_status'] = array(0=>'待审核',1=>'待用户认领',2=>'已失效',3=>'已返积分',4=>'待返积分',5=>'跟踪失败');	//返利订单类型
