...
class api_dataoke  {
    ...
    function __construct(){
        ...
        if($_G['setting']['syn_quan_time']>0){
         ...
         $dataoke_cate =  $_G['setting']['dataoke_cate'];
        $this->cates =  is_string($dataoke_cate) ? unserialize($dataoke_cate) : $dataoke_cate;
    }
    ...
    private function parse($goods_list){
        ...
        foreach ($goods_list as $k => $v) {
            ...
            //过滤比例
           if($_G['setting']['dtk_min_bili'] > 0 &&  $tmp['bili'] < $_G['setting']['dtk_min_bili']) continue;
