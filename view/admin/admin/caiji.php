 ...
 <tr class="noborder">
      ...
      <tr class="noborder" >
         ...
         <tr class="noborder hide" >
          ...
          <td class="vtop rowform"><input name="postdb[tk_pid]" value="{if $_G.setting.tk_pid}{$_G.setting.tk_pid}{/if}" type="text" class="txt"></td>
          <td class="vtop tips2">
        ...
        <tr class="noborder hide" >
          ...
          <td class="vtop rowform">
       {$_G.setting.tk_token}</td>
          <td class="vtop tips2">授权得到的token,禁止编辑</td>
        </tr>

        <tr class="noborder hide" >
          <td class="td_l">token到期时间:</td>
          <td class="vtop rowform">{$_G.setting.tk_token_time}</td>
         ...
         <tr class="noborder hide" >
          ...
          <a href="{$IMGDIR}/tk_api.png" target="_blank"><img src="{$IMGDIR}/tk_api.png" alt=""></a>
          </td>
