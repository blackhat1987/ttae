...
<input type="file" name="file" class="J_TCajaUploadImg upload_file_btn" data-url="/upload.php" />
 ...
 <tr class="noborder" >
          <td class="td_l">是否实物:</td>
          <td class="vtop rowform"><ul>
              <li >
                <input class="radio" type="radio" name="postdb[virtual]" value="1" {if $goods.virtual==1} checked="checked"{/if} >
                &nbsp;实物</li>
              <li>
                <input class="radio" type="radio" name="postdb[virtual]" value="2" {if $goods.virtual==2} checked="checked"{/if}>
                &nbsp;虚拟</li>
            </ul></td>
          <td class="vtop tips2" >实物,则需要填写联系人邮寄信息,如电话,地址等,虚拟,需填写支付宝或微信号</td>
        </tr>
