    ...
    <table class="tb tb2 nobdb">
      <tbody>
         ...
         <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="postdb[app_andorid_up_url]" value="{$_G.setting.app_andorid_up_url}" type="text" class="txt"></td>
        ...
        <tr class="noborder" >
         ...
         <tr class="noborder">
          ...
          <td class="vtop rowform"><input name="postdb[apply_android]" value="{$_G.setting.apply_android}" type="text" class="txt"></td>
