<?php /* Smarty version Smarty-3.1.15, created on 2017-08-09 11:28:50
         compiled from "C:\phpStudy\WWW\TTAE\v4_0\view\ttae\goods\main.php" */ ?>
<?php /*%%SmartyHeaderCode:18607598a80546f4a23-80616337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8b273848ff5166016e282967321aad8b0f74268' => 
    array (
      0 => 'C:\\phpStudy\\WWW\\TTAE\\v4_0\\view\\ttae\\goods\\main.php',
      1 => 1502249322,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18607598a80546f4a23-80616337',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.15',
  'unifunc' => 'content_598a805480fd63_02685467',
  'variables' => 
  array (
    'CSSDIR' => 0,
    '_G' => 0,
...
<?php if ($_valid && !is_callable('content_598a805480fd63_02685467')) {function content_598a805480fd63_02685467($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../header.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
">首页</a> > <a href="<?php echo $_smarty_tpl->tpl_vars['_G']->value['channel']['url'];?>
"><?php echo $_smarty_tpl->tpl_vars['_G']->value['channel']['name'];?>
...
<div class="bucuo_detail_con" <?php if ($_smarty_tpl->tpl_vars['_G']->value['setting']['dtk_jump']) {?>data-dtk_id="<?php echo $_smarty_tpl->tpl_vars['goods']->value['dtk_id'];?>
"<?php }?>>
...
"><?php if ($_smarty_tpl->tpl_vars['goods']->value['baoyou']==1) {?>[包邮]<?php }?><?php echo $_smarty_tpl->tpl_vars['goods']->value['title'];?>
          ...
          <li class="bucuo_de_bkico li2 lic<?php if ($_smarty_tpl->tpl_vars['goods']->value['status']==2||$_smarty_tpl->tpl_vars['goods']->value['status']==4) {?>2<?php } elseif ($_smarty_tpl->tpl_vars['goods']->value['status']==3) {?>3<?php } else { ?>1<?php }?>">

              <b>￥</b><span><?php echo $_smarty_tpl->tpl_vars['goods']->value['yh_price']-$_smarty_tpl->tpl_vars['goods']->value['juan_price'];?>
</span>
            <?php if ($_smarty_tpl->tpl_vars['goods']->value['price']>0) {?>   <span class="del">原价:<?php echo $_smarty_tpl->tpl_vars['goods']->value['price'];?>
元</span><?php }?>

          <?php if ($_smarty_tpl->tpl_vars['goods']->value['juan_url']) {?>
               <div class="goods_juan_url shadow"><a href="<?php echo $_smarty_tpl->tpl_vars['goods']->value['juan_url'];?>
" target="_blank">领<?php if ($_smarty_tpl->tpl_vars['goods']->value['juan_price']) {?><?php echo $_smarty_tpl->tpl_vars['goods']->value['juan_price'];?>
元<?php }?>优惠券</a></div>
        <?php }?>
        
              <a href="<?php echo $_smarty_tpl->tpl_vars['goods']->value['url'];?>
" class="go_btn" target="_blank" rel="nofollow" title="<?php echo $_smarty_tpl->tpl_vars['goods']->value['title'];?>
" isconvert="1" data-itemid= "<?php echo $_smarty_tpl->tpl_vars['goods']->value['num_iid'];?>
"></a>
          </li>
          <li class="li3">
      <?php if ($_smarty_tpl->tpl_vars['goods']->value['price']>0) {?>
              <span>
                  <h1>原价</h1>
              ...
              <?php if ($_smarty_tpl->tpl_vars['goods']->value['zk']>0) {?>
              <span>
                   <h1>折扣</h1>
...
&a=search&kw=<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
...
元</span>
 ...
 在 <span class="_dgmdate" data-time="<?php echo $_smarty_tpl->tpl_vars['goods']->value['start_time'];?>
"></span>进行特惠折扣减价促销活动,原价<?php echo $_smarty_tpl->tpl_vars['goods']->value['price'];?>
现价<?php echo $_smarty_tpl->tpl_vars['goods']->value['yh_price'];?>
,开始时间<span class="_dgmdate" data-time="<?php echo $_smarty_tpl->tpl_vars['goods']->value['start_time'];?>
"></span>结束时间<span class="_dgmdate" data-time="<?php echo $_smarty_tpl->tpl_vars['goods']->value['end_time'];?>
"></span>,过后恢复原价.
...
"><?php if ($_smarty_tpl->tpl_vars['v']->value['baoyou']==1) {?><b>【包邮】</b><?php }?><?php echo $_smarty_tpl->tpl_vars['v']->value['title'];?>
                     ...
                     <span>
                        ￥<em><?php echo $_smarty_tpl->tpl_vars['v']->value['yh_price']-$_smarty_tpl->tpl_vars['v']->value['juan_price'];?>
</em>
                        <?php if ($_smarty_tpl->tpl_vars['v']->value['price']>0) {?><del>￥<?php echo $_smarty_tpl->tpl_vars['v']->value['price'];?>
</del><?php }?>
                        <?php if ($_smarty_tpl->tpl_vars['v']->value['zk']>0) {?><b>（<?php echo $_smarty_tpl->tpl_vars['v']->value['zk'];?>
折）</b><?php }?>
                     </span>
                    </div>
