<?php /* Smarty version Smarty-3.1.15, created on 2017-08-09 11:40:33
         compiled from "C:\phpStudy\WWW\TTAE\v4_0\view\mobile\header.php" */ ?>
<?php /*%%SmartyHeaderCode:20497598a8431c79156-28692022%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e63ef78573398210ab227b39ffa64da1e860f107' => 
    array (
      0 => 'C:\\phpStudy\\WWW\\TTAE\\v4_0\\view\\mobile\\header.php',
      1 => 1482639138,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20497598a8431c79156-28692022',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598a8431d06332_18663972',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598a8431d06332_18663972')) {function content_598a8431d06332_18663972($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../common_mobile/header.php", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
?>
    <?php if ($_smarty_tpl->tpl_vars['v']->value['hide']==0) {?>
        <li><a class="_open" data-url="<?php echo $_smarty_tpl->tpl_vars['v']->value['url'];?>
...
m=index&a=all" class="mobile_get"><i></i><span>全部</span></a></li>
        <?php  $_smarty_tpl->tpl_vars['v'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['v']->_loop = false;
...
" class="mobile_get"><i ></i><span><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
</span></a></li>
         <?php }?>
        <?php } ?>
...
<div class="search_box">
   <form action="?" method="post">
       <input type="text" name="kw" placeholder="请输入你要搜索的内容" class="search_input"  value="<?php if ($_smarty_tpl->tpl_vars['_GET']->value['kw']) {?><?php echo $_smarty_tpl->tpl_vars['_GET']->value['kw'];?>
<?php }?>" />
