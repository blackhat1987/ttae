...
CREATE TABLE IF NOT EXISTS `ttae_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ttae_goods` (
  ...
  `dtk_id` int(11) NOT NULL,
  PRIMARY KEY (`aid`),
  KEY `num_iid` (`num_iid`),
  KEY `type` (`type`,`type_id`),
  KEY `aid_status` (`aid`,`status`,`title`),
  KEY `status` (`fid`,`status`),
  KEY `status_juan_type` (`status`,`juan_url`,`type_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3439 ;
...
CREATE TABLE IF NOT EXISTS `ttae_weixin_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `news_id` int(11) NOT NULL,
  `is_thumb` tinyint(1) NOT NULL,
  `url` varchar(150) NOT NULL,
  `weixin_url` varchar(150) NOT NULL,
  `dateline` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `url` (`url`),
  KEY `news_id` (`news_id`)
...
CREATE TABLE IF NOT EXISTS `ttae_weixin_news` (
  ...
  `username` varchar(30) NOT NULL,
  `show_pic` tinyint(1) NOT NULL,
  `dateline` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

CREATE TABLE IF NOT EXISTS `ttae_weixin_news_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(50) NOT NULL,
  `status` tinyint(1) NOT NULL,
  `mediaid` varchar(70) NOT NULL,
  `post_groupid` varchar(50) NOT NULL,
  `post_time` int(11) NOT NULL,
  `msg_id` varchar(20) NOT NULL,
  `msg_data_id` varchar(20) NOT NULL,
